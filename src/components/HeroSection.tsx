      ...
      <section className="min-h-screen flex flex-col justify-center relative overflow-hidden pt-16">
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10">
          ...
          >
            ...
            >
              Making Open-Source Contribution <span className="gradient-text">Fun Again.</span>
            </motion.h1>
            ...
            >
              Discover projects you'll love, earn achievements, and turn your contributions into
              real rewards. Open-source has never been this exciting.
            </motion.p>
