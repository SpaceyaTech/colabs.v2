    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-4xl relative z-10">
        <ScrollReveal className="text-center space-y-8">
          <h2 className="text-headline text-gradient-subtle">Ready to start contributing?</h2>

          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Join thousands of developers who are building their careers through meaningful
            open-source contributions. Start your journey today.
          </p>
