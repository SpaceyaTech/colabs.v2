  ...
  const topFeatures = [
    {
      ...
      description:
        'Track your contribution patterns, see detailed analytics of your open-source journey, and gain insights into your development progress.',
      color: 'text-blue-500',
    ...
    },
    {
      ...
      title: 'Marketplace',
      description:
        'Discover and purchase high-quality projects built by talented developers, or sell your own projects to a global community of developers.',
    ...
    },
    {
      ...
      description:
        'Access paying private projects to help younger developers and freelancers gain valuable experience while earning money for their contributions.',
  ...
  const features = [
    {
      ...
      description:
        'Monitor individual and team contributions with detailed metrics including commit frequency, code quality scores, and project completion rates.',
      color: 'text-blue-500',
      bgColor: 'bg-blue-500/10',
    },
    {
      ...
      description:
        'Track skill development across different technologies and frameworks with automated assessments and peer reviews.',
      color: 'text-green-500',
      bgColor: 'bg-green-500/10',
    },
    {
      ...
      description:
        'Set and monitor development goals for individuals and teams with milestone tracking and progress visualization.',
      color: 'text-purple-500',
      bgColor: 'bg-purple-500/10',
    },
    {
      ...
      description:
        'Understand time allocation across projects and identify bottlenecks to optimize development workflows.',
    ...
    },
    {
      ...
      description:
        'Automated code review metrics, security vulnerability tracking, and best practices compliance monitoring.',
      color: 'text-red-500',
    ...
    },
    {
      ...
      description:
        'Live collaboration metrics, pair programming insights, and team communication effectiveness scoring.',
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground text-lg">
            Transform your development journey with gamified contributions, real rewards, and
            ...
            >
              ...
              <div className="aspect-[4/3] bg-muted/30 relative overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <div
                    className={`w-10 h-10 ${feature.bgColor} rounded-lg flex items-center justify-center backdrop-blur-sm`}
                  >
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <p className="text-xl text-muted-foreground">
            Monitor, analyze, and optimize your team's performance with comprehensive analytics and
