...
const GamefiedSection = () => {
  ...
  const achievements = [
    { icon: Trophy, title: "First Contribution", description: "Make your first commit", color: "text-yellow-400" },
    { icon: Flame, title: "Streak Master", description: "7-day contribution streak", color: "text-orange-400" },
    { icon: GitPullRequest, title: "Code Reviewer", description: "Review 10 pull requests", color: "text-blue-400" },
    { icon: Star, title: "Open Source Hero", description: "Contribute to 25 projects", color: "text-purple-400" },
  ];
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-muted-foreground mb-8">
                  Unlock badges and rewards as you contribute to different projects and master new technologies.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {achievements.map((achievement, index) => (
                  <Card 
                    key={index} 
                    className="p-6 bg-card border-border feature-card"
                  >
