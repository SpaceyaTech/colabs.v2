  ...
  const features = [
    {
      ...
      description: "Track your contribution patterns and coding streaks. Analyze language usage and project impact with detailed visualizations.",
      link: "/dashboard",
    ...
    },
    {
      ...
      description: "Empower Technical Team Leads with advanced project insights. Help Product Managers track development velocity.",
      link: "/organizations",
    ...
    },
    {
      ...
      description: "Earn real money for quality contributions. Access sponsored project opportunities and performance-based rewards.",
      link: "/projects",
    ...
    },
    {
      icon: ShoppingCart,
      title: "Marketplace",
      description: "Browse thousands of freelance projects. Match your skills with perfect opportunities and secure payments.",
      link: "/marketplace",
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <ScrollReveal className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            ...
            Our goal is to create the platform we've always wished we had.
          </p>
        </ScrollReveal>
