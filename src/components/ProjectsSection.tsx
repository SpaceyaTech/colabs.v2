...
const ProjectsSection = () => {
  const projects = [
    ...
    },
    {
      ...
      description:
        'Secure authentication service with JWT tokens, OAuth integration, and user management.',
      language: 'JavaScript',
      stars: 892,
      forks: 156,
    ...
    },
    {
      ...
      description:
        'Advanced data processing and visualization toolkit for analyzing large datasets.',
      language: 'Python',
      stars: 567,
      forks: 78,
      difficulty: 'Advanced',
    ...
    },
    {
      ...
      description:
        'Lightweight framework for building scalable microservices with service discovery.',
      language: 'Go',
      stars: 445,
      forks: 67,
      difficulty: 'Advanced',
    ...
    <section className="py-24 relative">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <ScrollReveal className="text-center mb-16">
          <h2 className="text-headline text-gradient-subtle mb-6">Discover amazing projects</h2>
        ...
        <ScrollReveal delay={0.1}>
          <div className="flex flex-wrap justify-center gap-2 mb-12">
            {['All', 'Beginner Friendly', 'TypeScript', 'Python', 'Go', 'JavaScript'].map(
              (filter, index) => (
                <Button
                  key={filter}
              ...
              <Card className="p-6 bg-card border-border feature-card group cursor-pointer h-full">
                <div className="space-y-4">
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <Badge
                      variant="outline"
                      className={`text-xs ${getDifficultyColor(project.difficulty)} border-0`}
                    >
                      {project.difficulty}
                    </Badge>
                  </div>
