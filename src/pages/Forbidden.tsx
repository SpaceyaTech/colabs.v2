      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          ...
          >
            ...
            <motion.g animate={{ y: [-2, 2, -2] }} transition={{ duration: 1.5, repeat: Infinity }}>
              ...
              <path
                d="M242 115 V105 Q250 95 258 105 V115"
                stroke="hsl(var(--primary))"
                strokeWidth="4"
                fill="none"
              />
        ...
        >
          ...
          <p className="text-muted-foreground mb-8 max-w-md mx-auto">
            Halt! You don't have permission to access this area. This might be a restricted zone, or
            you may need to log in with the right credentials.
          </p>
