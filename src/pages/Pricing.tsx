...
const Pricing = () => {
  ...
  const getButtonLabel = (planKey: PlanType) => {
    if (!user) return planKey === "starter" ? "Get Started Free" : `Choose ${planKey === "pro_plus" ? "Pro+" : "Pro"}`;
    if (planKey === currentPlan) return "Current Plan";
    return planKey === "starter" ? "Downgrade" : `Upgrade to ${planKey === "pro_plus" ? "Pro+" : "Pro"}`;
  };
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-xl max-w-3xl mx-auto">
              Scale your open-source contributions with our flexible pricing
              options. Start free and upgrade as your team grows.
            </p>
