      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          ...
          >
            ...
            >
              <text x="250" y="80" fontSize="40" fill="hsl(var(--primary))" fontWeight="bold">
                ?
              </text>
            </motion.g>
        ...
        >
          ...
          <h2 className="text-2xl font-semibold text-foreground mb-3">Lost in Space</h2>
